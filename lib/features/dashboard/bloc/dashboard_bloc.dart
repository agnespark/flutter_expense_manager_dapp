...
class DashboardBloc extends Bloc<DashboardEvent, DashboardState> {
  ...
  FutureOr<void> dashboardInitialFechEvent(
    ...
    try {
      ...
      String privateKey =
          "0x620e2690ef212075579ad9616524a7d2d44f014801af0c20d538a12f1d472f5f";
      ...
      _contractAddress =
          EthereumAddress.fromHex("0x7D8B4FF5eF51b1F82F4B256494513e547DE6bdF8");
    ...
    try {
      final transaction = Transaction.callContract(
          from: EthereumAddress.fromHex(
              "0x7D8B4FF5eF51b1F82F4B256494513e547DE6bdF8"),
          contract: _deployedContract,
          function: _deposit,
          parameters: [
      ...
      final result = await _web3Client!.sendTransaction(_creds, transaction,
          chainId: 5777, fetchChainIdFromNetworkId: false);
      log(result.toString());
